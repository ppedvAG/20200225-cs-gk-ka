...
namespace DEntityFrCore.Migrations
{
    ...
    [Migration("20200228144621_initialcreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DEntityFrCore.Anschrift", b =>
                {
                    ...
                    b.Property<int?>("KundeInAnschriftKundenId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("KundeInAnschriftKundenId");
            ...
            modelBuilder.Entity("DEntityFrCore.Anschrift", b =>
                {
                    b.HasOne("DEntityFrCore.Kunde", "KundeInAnschrift")
                        .WithMany("Anschriften")
                        .HasForeignKey("KundeInAnschriftKundenId");
                });
